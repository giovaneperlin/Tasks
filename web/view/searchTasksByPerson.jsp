    ...
    <body>
        ...
        <div id="container" class="container" style="width: 90%; margin-top: 60px;">
            <div class="row" style="margin-top: 10px;">
                <form action="/Tasks/searchedTasksByPerson" method="POST">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group">
                                <input type="text" name="name" class="form-control" placeholder="Buscar por nome da pessoa">
                                <span class="input-group-btn">
                                    <input type="submit" value="Buscar" class="btn btn-primary" type="button">
                                </span>
                            </div>
                        </div>
                    </div>
